			...
			compilation => {
				compilation.hooks.finishModules.tap(
					...
					modules => {
						...
						let moduleProvidedExportsWithDeps;
						...
						const processDependency = dep => {
							...
							if (exportDeps) {
								moduleProvidedExportsWithDeps = true;
						...
						for (const module of modules) {
							if (module.buildMeta.providedExportsWithDeps) {
						...
						while (queue.length > 0) {
							...
							if (module.buildMeta.providedExports !== true) {
								...
								moduleProvidedExports = Array.isArray(
									...
									: new Set();
								moduleProvidedExportsWithDeps = false;
								processDependenciesBlock(module);
								module.buildMeta.providedExportsWithDeps = moduleProvidedExportsWithDeps;
